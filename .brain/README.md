...
| `[.brain/Syllabus.md](Syllabus.md)` | Master curriculum mappings for all five tracks with real-time backlog and completion tracking. | Read to verify current lesson targets and assign topics. |
...
1. **Data Structures & Algorithms (DSA)**: Striver's TUF Plus structured roadmap implemented in **Java**. Focuses on SDE-level problem solving, time/space complexity optimization, and clean Java styling.
